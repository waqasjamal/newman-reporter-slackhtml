...
function slackMessage(stats, timings, failures, executions, maxMessageSize, collection, environment, channel, reportingUrl, buildUrl, limitFailures) {
...
function buildUrlSection(buildUrl) {
    if (buildUrl) {
        return `{
            "type": "section",
            "text": {
